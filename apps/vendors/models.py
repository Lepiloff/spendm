...
class VendorContacts(models.Model):
    ...
    # sec_contact_name = models.CharField(max_length=45, blank=True)
    # sec_email = models.CharField(max_length=80, blank=True)
    # sec_phone = models.CharField(max_length=45, blank=True)
