# Generated by Django 2.2.9 on 2020-02-21 13:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module_name', models.CharField(choices=[('Sourcing', 'Sourcing'), ('SA', 'SA'), ('SXM', 'SXM'), ('CLM', 'CLM'), ('ePRO', 'ePRO'), ('I2P', 'I2P'), ('P2P', 'P2P'), ('SPT', 'SPT'), ('S2P', 'S2P'), ('AP', 'AP'), ('TS', 'TS'), ('SOW', 'SOW'), ('ICW', 'ICW')], max_length=50)),
        ...
        migrations.CreateModel(
            name='Rfis',
            fields=[
                ('rfiid', models.AutoField(primary_key=True, serialize=False)),
                ('active', models.BooleanField(default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField()),
                ('c', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vendors.Categories')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_name', models.CharField(blank=True, max_length=45)),
                ('phone', models.CharField(blank=True, max_length=45)),
                ('email', models.CharField(blank=True, max_length=80, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField()),
                ('s', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vendors.Subcategories')),
            ],
            options={
                'db_table': 'elements',
        ...
        migrations.AddField(
            ...
            name='pc',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vendors.ParentCategories'),
        ),
        migrations.CreateModel(
            name='Calendar',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('persona', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='vendors.Personas')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vendor', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='vendors.Vendors')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('user_to_assign', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, related_name='user_to_assign', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
                ('vendor', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='vendors.Vendors')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('e', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='vendors.Elements')),
                ('rfi', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='vendors.Rfis')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
                ('vendor', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='vendors.Vendors')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pc', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vendors.ParentCategories')),
                ('rfi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vendors.Rfis')),
                ('vendor', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='vendors.Vendors')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.IntegerField()),
                ('timestamp', models.DateTimeField()),
                ('m', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vendors.Modules')),
                ('rfi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vendors.Rfis')),
                ('vendor', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='vendors.Vendors')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(blank=True, null=True)),
                ('m', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='vendors.Modules')),
                ('reference', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='vendors.References')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.IntegerField(blank=True, null=True)),
                ('timestamp', models.DateTimeField()),
                ('e', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vendors.Elements')),
                ('m', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='vendors.Modules')),
                ('rfi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vendors.Rfis')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.BooleanField(default=True)),
                ('vendor_response', models.IntegerField(blank=True, null=True)),
                ('attachment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vendors.Attachments')),
                ('e', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='vendors.Elements')),
                ('rfi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vendors.Rfis')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='CIAnswers',
            fields=[
                ('c_i_answersid', models.AutoField(primary_key=True, serialize=False)),
                ('answer', models.CharField(blank=True, max_length=1000, null=True)),
                ('timestamp', models.DateTimeField(blank=True, null=True)),
                ('c_i_question', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vendors.CIQuestions')),
                ('rfi', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='vendors.Rfis')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('vendor', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='vendors.Vendors')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participation_mode', models.CharField(choices=[('0', '0'), ('1', '1'), ('2', '2')], max_length=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(blank=True, null=True)),
                ('event', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='vendors.Calendar')),
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
                ('vendor', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='vendors.Vendors')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_id', models.IntegerField()),
                ('timestamp', models.DateTimeField()),
                ('analyst', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
                ('vendor', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='vendors.Vendors')),
            ],
            options={
