...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('analyst', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to=settings.AUTH_USER_MODEL)),
                ('active', models.IntegerField()),
                ('user_id', models.IntegerField()),
                ('timestamp', models.DateTimeField()),
                ('vendor', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='vendors.Vendors')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('persona', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='vendors.Personas')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('m', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='vendors.Modules')),
        ...
        migrations.CreateModel(
            name='SurveyAnswers',
            fields=[
                ('vendor', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='vendors.Vendors')),
                ('answer', models.CharField(blank=True, max_length=1000, null=True)),
                ('timestamp', models.DateTimeField(blank=True, null=True)),
                ('question', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='vendors.SurveyQuestions')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('reference', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='vendors.References')),
                ('active', models.IntegerField()),
                ('timestamp', models.DateTimeField(blank=True, null=True)),
                ('m', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='vendors.Modules')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('event', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='vendors.Calendar')),
                ('active', models.IntegerField()),
